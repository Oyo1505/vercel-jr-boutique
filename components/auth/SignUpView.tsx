...
import useSignup from '../../app/api/auth/use-signup';
...
const SignUpView: FC = () => {
  ...
  return (
    <form onSubmit={handleSignup} className="flex w-80 flex-col justify-between p-3">
      ...
      <div className="flex flex-col space-y-4">
        {message && (
          <div
            className="text-red border-red border p-3"
