...
const MentionsLegalesPage = () => {
  return (
    <section className={styles.container}>
      ...
      <p>
        L’utilisation du site <a href="https://jr-boutique.fr/">https://jr-boutique.fr/</a> implique
        l’acceptation pleine et entière des conditions générales d’utilisation ci-après décrites.
        Ces conditions d’utilisation sont susceptibles d’être modifiées ou complétées à tout moment,
        les utilisateurs du site <a href="https://jr-boutique.fr/">https://jr-boutique.fr/</a> sont
      ...
      <p>
        ...
        raison de maintenance technique peut être toutefois décidée par JR Distribution, qui
        s’efforcera alors de communiquer préalablement aux utilisateurs les dates et heures de
        l’intervention.
      </p>

      <p>
        Le site <a href="https://jr-boutique.fr/">https://jr-boutique.fr/</a> est mis à jour
        régulièrement par Henri-Pierre RIGOULET. De la même façon, les mentions légales peuvent être
        modifiées à tout moment : elles s’imposent néanmoins à l’utilisateur qui est invité à s’y
        référer le plus souvent possible afin d’en prendre connaissance.
      </p>

      <h2>3. Description des services fournis</h2>
      <p>
        Le site <a href="https://jr-boutique.fr/">https://jr-boutique.fr/</a> a pour objet de
      ...
      <p>
        ...
        du site. De plus, l’utilisateur du site s’engage à accéder au site en utilisant un matériel
        récent, ne contenant pas de virus et avec un navigateur de dernière génération mis-à-jour
      </p>

      <h2>5. Propriété intellectuelle et contrefaçons</h2>
      <p>
        JR Distribution est propriétaire des droits de propriété intellectuelle ou détient les
      ...
      <p>
        ...
        autorisation écrite préalable de : JR Distribution.
      </p>
      ...
      <p>
        ...
        disposition des utilisateurs. JR Distribution se réserve le droit de supprimer, sans mise en
        demeure préalable, tout contenu déposé dans cet espace qui contreviendrait à la législation
        applicable en France, en particulier aux dispositions relatives à la protection des
        données...
      </p>
      ...
      <p>
        Le site <a href="https://jr-boutique.fr/">https://jr-boutique.fr/</a> contient un certain
        nombre de liens hypertextes vers d’autres sites, mis en place avec l’autorisation de JR
        Distribution. Cependant, JR Distribution n’a pas la possibilité de vérifier le contenu des
        sites ainsi visités, et n’assumera en conséquence aucune responsabilité de ce fait.
      </p>

      <p>
        La navigation sur le site <a href="https://jr-boutique.fr/">https://jr-boutique.fr/</a> est
      ...
      <ul>
        ...
        <li>
          Sous Firefox : en haut de la fenêtre du navigateur, cliquez sur le bouton Firefox, puis
          aller dans l’onglet Options. Cliquer sur l’onglet Vie privée. Paramétrez les Règles de
          conservation sur : utiliser les paramètres personnalisés pour l’historique. Enfin
        ...
        <li>
          ...
          par un rouage). Sélectionnez Paramètres. Cliquez sur Afficher les paramètres avancés. Dans
          la section « Confidentialité », cliquez sur Paramètres de contenu. Dans la section «
          Cookies », vous pouvez bloquer les cookies.
        </li>
        <li>
          Sous Chrome : Cliquez en haut à droite du navigateur sur le pictogramme de menu (symbolisé
          par trois lignes horizontales). Sélectionnez Paramètres. Cliquez sur Afficher les
